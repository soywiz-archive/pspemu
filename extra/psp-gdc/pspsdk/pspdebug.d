...
/**
  ...
  * @param ... - Arguments
  */
void pspDebugScreenPrintf(char *fmt, ...);
...
/**
  ...
  * @param ... - Arguments
  */
void pspDebugScreenKprintf(char *format, ...);
 ...
 */
void pspDebugScreenSetMaxX(uint maxx);
 ...
 * @param maxx - The X maximum coordinate 
 */
void pspDebugScreenSetMaxY(uint maxy);
...
/**
  ...
  */
int pspDebugScreenPrintData(char *buff, int size);
 ...
 * @return The number of characters written
 */
int pspDebugScreenPuts(char *str);
...
*/
int pspDebugGetStackTrace(uint* results, int max);

/**
 * Enable the clear line function that allows debug to clear the screen
*/
void pspDebugScreenClearLineEnable();
...
alias void function(PspDebugRegBlock *regs) PspDebugErrorHandler;
...
alias int function(char *format, u32 *args) PspDebugKprintfHandler;
//typedef int (*PspDebugKprintfHandler)(char *format, u32 *args);
...
void pspDebugProfilerEnable();

/** Disables the profiler hardware */
void pspDebugProfilerDisable();
...
void pspDebugProfilerPrint();

/** Type for the debug print handlers */
alias int function(char *data, int len) PspDebugPrintHandler;
//typedef int (*PspDebugPrintHandler)(char *data, int len);

/** Type for the debug input handler */
alias int function(char *data, int len) PspDebugInputHandler;
 ...
 */
int pspDebugSioPutData(char *data, int len);
