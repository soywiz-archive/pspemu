...
extern (C)
{
	...
	void sceGumDrawArrayN(int prim, int vtype, int count, int a3, void* indices, void* vertices);
	void sceGumDrawBezier(int vtype, int ucount, int vcount, void* indices, void* vertices);
	void sceGumDrawSpline(int vtype, int ucount, int vcount, int uedge, int vedge, void* indices, void* vertices);
	...
	**/
	void sceGumLoadMatrix(ScePspFMatrix4* m);
	...
	**/
	void sceGumMultMatrix(ScePspFMatrix4* m);
	...
	**/
	void sceGumRotateXYZ(ScePspFVector3* v);
	...
	/**
	  ...
	  * @param v - Pointer to vector containing angles
	**/
	void sceGumRotateZYX(ScePspFVector3* v);
	...
	**/
	void sceGumBeginObject(int vtype, int count, void* indices, void* vertices);
	...
	**/
	...
	void gumLoadMatrix(ScePspFMatrix4* r, ScePspFMatrix4* a);
	void gumLookAt(ScePspFMatrix4* m, ScePspFVector3* eye, ScePspFVector3* center, ScePspFVector3* up);
	void gumMultMatrix(ScePspFMatrix4* result, ScePspFMatrix4* a, ScePspFMatrix4* b);
	...
	void gumRotateXYZ(ScePspFMatrix4* m, ScePspFVector3* v);
	void gumRotateY(ScePspFMatrix4* m, float angle);
	void gumRotateZ(ScePspFMatrix4* m, float angle);
	void gumRotateZYX(ScePspFMatrix4* m, ScePspFVector3* v);
	void gumScale(ScePspFMatrix4* m, ScePspFVector3* v);
	void gumTranslate(ScePspFMatrix4* m, ScePspFVector3* v);
	void gumFullInverse(ScePspFMatrix4* r, ScePspFMatrix4* a);
	...
	**/
	void gumFastInverse(ScePspFMatrix4* r, ScePspFMatrix4* a);

	// vector functions

	void gumCrossProduct(ScePspFVector3* r, ScePspFVector3* a, ScePspFVector3* b);
	float gumDotProduct(ScePspFVector3* a, ScePspFVector3* b);
