...
alias PspThreadAttributes.PSP_THREAD_ATTR_VFPU THREAD_ATTR_VFPU;
alias PspThreadAttributes.PSP_THREAD_ATTR_USER THREAD_ATTR_USER;
...
alias SceUInt function(void *common) SceKernelAlarmHandler;
 ...
 * @return 0 on success, < 0 on error
 */
int sceKernelSendMsgPipeCB(SceUID uid, void *message, uint size, int unk1, void *unk2, uint *timeout);
 ...
 * @return 0 on success, < 0 on error
 */
int sceKernelReceiveMsgPipeCB(SceUID uid, void *message, uint size, int unk1, void *unk2, uint *timeout);
 ...
 */
SceUID sceKernelCreateVpl(/*const*/ char *name, int part, int attr, uint size, SceKernelVplOptParam *opt);
 ...
 * @return 0 on success, < 0 on error
 */
int sceKernelAllocateVpl(SceUID uid, uint size, void **data, uint *timeout);
 ...
 * @return 0 on success, < 0 on error
 */
int sceKernelAllocateVplCB(SceUID uid, uint size, void **data, uint *timeout);
 ...
 * @return 0 on success, < 0 on error
 */
int sceKernelAllocateFpl(SceUID uid, void **data, uint *timeout);
 ...
 * @return 0 on success, < 0 on error
 */
int sceKernelAllocateFplCB(SceUID uid, void **data, uint *timeout);
 ...
 * @return 0 on success, < 0 on error
 */
int sceKernelUSec2SysClock(uint usec, SceKernelSysClock *clock);
 ...
 * @return 0 on success, < 0 on error
 */
int sceKernelSysClock2USec(SceKernelSysClock *clock, uint *low, uint *high);
 ...
 * @return 0 on success, < 0 on error
 */
int sceKernelSysClock2USecWide(SceInt64 clock, uint *low, uint *high);
...
alias int function(int mask, SceUID thid, void* common) SceKernelThreadEventHandler;
