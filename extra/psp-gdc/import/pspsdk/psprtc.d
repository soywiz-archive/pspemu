 ...
 */
module pspsdk.psptrc;

private import pspsdk.psptypes;
...
extern( C )
{
	 ...
	 * @return 0 on success, < 0 on error
	 */
	int sceRtcConvertLocalTimeToUTC(u64* tickLocal, u64* tickUTC);
	 ...
	 */
	int sceRtcCheckValid(pspTime* date);
	 ...
	 * @return 0 on success, < 0 on error
	 */
	int sceRtcSetTick(pspTime* date, u64* tick);
	 ...
	 * @return 0 on success, < 0 on error
	 */
	int sceRtcGetTick(pspTime* date, u64 *tick);
	 ...
	 */
	int sceRtcCompareTick(u64* tick1, u64* tick2);
	 ...
	 * @return 0 on success, <0 on error
	 */
	int sceRtcTickAddTicks(u64* destTick, u64* srcTick, u64 numTicks);
	 ...
	 * @return 0 on success, <0 on error
	 */
	int sceRtcTickAddMicroseconds(u64* destTick, u64* srcTick, u64 numMS);
	 ...
	 * @return 0 on success, <0 on error
	 */
	int sceRtcTickAddSeconds(u64* destTick, u64* srcTick, u64 numSecs);
	 ...
	 * @return 0 on success, <0 on error
	 */
	int sceRtcTickAddMinutes(u64* destTick, u64* srcTick, u64 numMins);
	 ...
	 * @return 0 on success, <0 on error
	 */
	int sceRtcTickAddHours(u64* destTick, u64* srcTick, int numHours);
	 ...
	 * @return 0 on success, <0 on error
	 */
	int sceRtcTickAddDays(u64* destTick, u64* srcTick, int numDays);
	 ...
	 * @return 0 on success, <0 on error
	 */
	int sceRtcTickAddWeeks(u64* destTick, u64* srcTick, int numWeeks);
	 ...
	 * @return 0 on success, <0 on error
	 */
	int sceRtcTickAddMonths(u64* destTick, u64* srcTick, int numMonths);
	 ...
	 * @return 0 on success, <0 on error
	 */
	int sceRtcTickAddYears(u64* destTick, u64* srcTick, int numYears);

	int sceRtcSetTime_t(pspTime* date, time_t time);
	...
	int sceRtcParseDateTime(u64 *destTick, char *dateString);
	/*
	sceRtcFormatRFC2822
