...
const PspInstructions_FPU = [
	...
	ID( "c.ueq.s",     VM(0x46000033, 0xFFE007FF), "%S, %T",     ADDR_TYPE_NONE, 0 ),
	ID( "c.olt.s",     VM(0x46000034, 0xFFE007FF), "%S, %T",     ADDR_TYPE_NONE, 0 ),
	ID( "c.ult.s",     VM(0x46000035, 0xFFE007FF), "%S, %T",     ADDR_TYPE_NONE, 0 ),
	ID( "c.ole.s",     VM(0x46000036, 0xFFE007FF), "%S, %T",     ADDR_TYPE_NONE, 0 ),
	ID( "c.ule.s",     VM(0x46000037, 0xFFE007FF), "%S, %T",     ADDR_TYPE_NONE, 0 ),
	ID( "c.sf.s",      VM(0x46000038, 0xFFE007FF), "%S, %T",     ADDR_TYPE_NONE, 0 ),
	ID( "c.ngle.s",    VM(0x46000039, 0xFFE007FF), "%S, %T",     ADDR_TYPE_NONE, 0 ),
	ID( "c.seq.s",     VM(0x4600003A, 0xFFE007FF), "%S, %T",     ADDR_TYPE_NONE, 0 ),
	ID( "c.ngl.s",     VM(0x4600003B, 0xFFE007FF), "%S, %T",     ADDR_TYPE_NONE, 0 ),
	ID( "c.lt.s",      VM(0x4600003C, 0xFFE007FF), "%S, %T",     ADDR_TYPE_NONE, 0 ),
...
const PspInstructions_UNGROUPED = [
	/* MIPS instructions */
	ID( "break",              VM(0x0000000D, 0xFC00003F), "%c",     ADDR_TYPE_NONE, 0 ),
	...
	ID( "max",                VM(0x0000002C, 0xFC0007FF), "%d, %s, %t", ADDR_TYPE_NONE, INSTR_TYPE_PSP ),
	ID( "min",                VM(0x0000002D, 0xFC0007FF), "%d, %s, %t", ADDR_TYPE_NONE, INSTR_TYPE_PSP ),
	ID( "dbreak",             VM(0x7000003F, 0xFFFFFFFF), "", ADDR_TYPE_NONE, INSTR_TYPE_PSP ),
	ID( "div",                VM(0x0000001A, 0xFC00FFFF), "%s, %t", ADDR_TYPE_NONE, 0 ),
	ID( "divu",               VM(0x0000001B, 0xFC00FFFF), "%s, %t", ADDR_TYPE_NONE, 0 ),
	ID( "dret",               VM(0x7000003E, 0xFFFFFFFF), "", ADDR_TYPE_NONE, INSTR_TYPE_PSP ),
	ID( "eret",               VM(0x42000018, 0xFFFFFFFF), "", ADDR_TYPE_NONE, 0 ),
	ID( "ext",                VM(0x7C000000, 0xFC00003F), "%t, %s, %a, %ne", ADDR_TYPE_NONE, INSTR_TYPE_PSP ),
	ID( "ins",                VM(0x7C000004, 0xFC00003F), "%t, %s, %a, %ni", ADDR_TYPE_NONE, INSTR_TYPE_PSP ),
	...
	ID( "movz",               VM(0x0000000A, 0xFC0007FF), "%d, %s, %t", ADDR_TYPE_NONE, INSTR_TYPE_PSP ),
	...
	ID( "mthi",               VM(0x00000011, 0xFC1FFFFF), "%s", ADDR_TYPE_NONE, 0 ),
	ID( "mtlo",               VM(0x00000013, 0xFC1FFFFF), "%s", ADDR_TYPE_NONE, 0 ),
	ID( "mult",               VM(0x00000018, 0xFC00FFFF), "%s, %t", ADDR_TYPE_NONE, 0 ),
	ID( "multu",              VM(0x00000019, 0xFC0007FF), "%s, %t", ADDR_TYPE_NONE, 0 ),

	ID( "sync",               VM(0x0000000F, 0xFFFFFFFF), "", ADDR_TYPE_NONE, 0 ),
	ID( "syscall",            VM(0x0000000C, 0xFC00003F), "%C", ADDR_TYPE_NONE, 0 ),
...
ID[] PspInstructions() {
	return (
		...
		PspInstructions_LSU ~
		PspInstructions_FPU ~
		//PspInstructions_VFPU ~ // Temporary disabled.
