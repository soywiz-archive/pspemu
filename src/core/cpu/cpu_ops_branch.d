...
template TemplateCpu_BRANCH() {
	...
	void OP_BEQL() { mixin(BRANCH(Likely.NO , Link.NO , "registers[instruction.RS] == registers[instruction.RT]")); }
	...
	void OP_BNEL() { mixin(BRANCH(Likely.NO , Link.NO , "registers[instruction.RS] != registers[instruction.RT]")); }
}
