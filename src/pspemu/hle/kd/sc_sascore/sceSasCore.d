...
class sceSasCore : HleModuleHost {
	mixin TRegisterModule;

	void initNids() {
		mixin(registerFunction!(0x42778A9F, __sceSasInit));
	    mixin(registerFunction!(0x019B25EB, __sceSasSetADSR));
	    mixin(registerFunction!(0x267A6DD2, __sceSasRevParam));
	    mixin(registerFunction!(0x2C8E6AB3, __sceSasGetPauseFlag));
	    mixin(registerFunction!(0x33D4AB37, __sceSasRevType));
	    mixin(registerFunction!(0x440CA7D8, __sceSasSetVolume));
	    mixin(registerFunction!(0x50A14DFC, __sceSasCoreWithMix));
	    mixin(registerFunction!(0x5F9529F6, __sceSasSetSL));
	    mixin(registerFunction!(0x68A46B95, __sceSasGetEndFlag));
	    mixin(registerFunction!(0x74AE582A, __sceSasGetEnvelopeHeight));
	    mixin(registerFunction!(0x76F01ACA, __sceSasSetKeyOn));
	    mixin(registerFunction!(0x787D04D5, __sceSasSetPause));
	    mixin(registerFunction!(0x99944089, __sceSasSetVoice));
	    mixin(registerFunction!(0x9EC3676A, __sceSasSetADSRmode));
	    mixin(registerFunction!(0xA0CF2FA4, __sceSasSetKeyOff));
	    mixin(registerFunction!(0xA3589D81, __sceSasCore));
	    mixin(registerFunction!(0xAD84D37F, __sceSasSetPitch));
	    mixin(registerFunction!(0xB7660A23, __sceSasSetNoise));
	    mixin(registerFunction!(0xCBCD4F79, __sceSasSetSimpleADSR));
	    mixin(registerFunction!(0xD5A229C9, __sceSasRevEVOL));
	    mixin(registerFunction!(0xF983B186, __sceSasRevVON));
	    
	    mixin(registerFunction!(0xBD11B7C2, __sceSasGetGrain));
	    mixin(registerFunction!(0xD1E0A01E, __sceSasSetGrain));
	    mixin(registerFunction!(0xE175EF66, __sceSasGetOutputmode));
	    mixin(registerFunction!(0xE855BF76, __sceSasSetOutputmode));
	}
